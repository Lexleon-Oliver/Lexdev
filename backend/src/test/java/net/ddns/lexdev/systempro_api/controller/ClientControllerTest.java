...
class ClientControllerTest {
    ...
    void deveRetornarClientePeloId() throws Exception {
        ...
        mockMvc.perform(get("/clients/1"))
                ...
                .andExpect(jsonPath("$.logradouro").value("Avenida Doutor Paulo Ramos"))
    ...
    void deveRetornar404QuandoClienteNaoExistir() throws Exception {
        ...
        when(service.findById(999L))
                .thenThrow(new EntityNotFoundException("Cliente não encontrado com o ID: 999"));

        mockMvc.perform(get("/clients/999"))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404))
                .andExpect(jsonPath("$.error").value("Recurso Não Encontrado"))
                .andExpect(jsonPath("$.message").value("Cliente não encontrado com o ID: 999"))
                .andExpect(jsonPath("$.path").value("/clients/999"));
    ...
    void deveCriarCliente() throws Exception {
        ...
        when(service.create(any(ClientRequestDto.class))).thenReturn(response);
    ...
    void deveAtualizarCliente() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.id").value(1))
                .andExpect(jsonPath("$.personId").value(10))
                .andExpect(jsonPath("$.name").value("João da Silva Atualizado"))
                .andExpect(jsonPath("$.cpfCnpj").value("12345678900"))
                .andExpect(jsonPath("$.email").value("joaoatualizado@email.com"))
                .andExpect(jsonPath("$.phone").value("32999999999"))
                .andExpect(jsonPath("$.active").value(true));
    ...
    void deveRetornar400QuandoDadosDoClienteForemInvalidosNoUpdate() throws Exception {
        ...
        verify(service, never()).update(eq(1L), any(ClientRequestDto.class));
    }
    ...
    void deveRetornar404AoAtualizarClienteInexistente() throws Exception {
        ...
        verify(service).update(eq(999L), any(ClientRequestDto.class));
    }
    ...
    void deveRetornar404AoExcluirClienteInexistente() throws Exception {
        ...
        doThrow(new EntityNotFoundException("Cliente não encontrado com o ID: 999"))
